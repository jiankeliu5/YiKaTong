...
public class Images {
	...
	Images images = null;
	public Images newInstance(){
		if(images == null){
			images = new Images(ctx,objects);
		}
		return images;
	}
	public Images(Context ctx,ArrayList<Object>   objects){
		this.ctx = ctx;
    ...
    public void getData(ArrayList<Object>   objects){	   
				imageThumbUrls= new String[objects.size()];
				for (int i = 0; i < objects.size(); i++) {
					imageThumbUrls[i]="https://lh4.googleusercontent.com/-e9NHZ5k5MSs/URqvMIBZjtI/AAAAAAAAAbs/1fV810rDNfQ/s160-c/Yosemite%252520Tree.jpg";
				}
				   	  
    }
    public String[] photoThumbUrls;
