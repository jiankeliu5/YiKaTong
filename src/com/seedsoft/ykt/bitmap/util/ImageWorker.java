...
public abstract class ImageWorker {
    ...
    protected boolean mPauseWork = false;//线程暂停标志
    private final Object mPauseWorkLock = new Object();//暂停线程锁对象，处理暂停任务时候，将线程置于等待挂起状态
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, BitmapDrawable> {
        private Object data;
        private final WeakReference<ImageView> imageViewReference;//弱引用优化内存
        //带参构造函数
