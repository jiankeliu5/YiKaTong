...
public class ImageCache {
    ...
    private static final CompressFormat DEFAULT_COMPRESS_FORMAT = CompressFormat.PNG;//压缩格式 感谢上帝，在此处帮助我。jpeg格式会产生透明图片黑底。
    private static final int DEFAULT_COMPRESS_QUALITY = 70;
    private static final int DISK_CACHE_INDEX = 0;

    // Constants to easily toggle various caches切换不同的缓存
