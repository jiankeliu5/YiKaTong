...
//        	Toast toast = Toast.makeText(BaseApplication.getInstance().getApplicationContext(), 
...
//	            	Toast toast =  Toast.makeText(BaseApplication.getInstance().getApplicationContext(), "您的网络出错啦！",
//	                    Toast.LENGTH_LONG);
//	            	toast.getView().setBackgroundResource(R.drawable.red_toast_bg);
//	    			toast.getView().setPadding(20, 10, 20, 10);
//	    			toast.show();
...
//	            	Toast toast =   Toast.makeText(BaseApplication.getInstance().getApplicationContext(), "输入正确的检索条件！",
//	                        Toast.LENGTH_LONG);
//	                toast.getView().setBackgroundResource(R.drawable.red_toast_bg);
//	    			toast.getView().setPadding(20, 10, 20, 10);
//	    			toast.show();
